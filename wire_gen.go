...
func InitializeApp() (*App, error) {
	...
	fluxApplicationServiceImpl := FluxApplicationService.NewFluxApplicationServiceImpl(sugaredLogger, clusterRepositoryImpl, k8sK8sServiceImpl, clusterBeanConverterImpl)
