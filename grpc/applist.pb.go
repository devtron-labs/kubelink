...
var file_gRPC_applist_proto_rawDesc = []byte{
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x88, 0x02, 0x0a, 0x15, 0x55,
	...
	0x49, 0x6e, 0x43, 0x74, 0x78, 0x12, 0x1e, 0x0a, 0x0a, 0x4b, 0x38, 0x73, 0x56, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x4b, 0x38, 0x73, 0x56, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x32, 0x0a, 0x16, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65,
	...
	0x65, 0x64, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x22, 0x9d, 0x01, 0x0a, 0x1e, 0x54,
	...
	0x52, 0x4c, 0x32, 0xbf, 0x0c, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69,
...
var file_gRPC_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_gRPC_applist_proto_goTypes = []interface{}{
	...
	(*TemplateChartResponseWithChart)(nil), // 41: TemplateChartResponseWithChart
	...
	(*OCIRegistryResponse)(nil),            // 52: OCIRegistryResponse
	(*OCIRegistryPushResponse)(nil),        // 53: OCIRegistryPushResponse
	nil,                                    // 54: ResourceNetworkingInfo.LabelsEntry
	nil,                                    // 55: ResourceIdentifier.LabelsEntry
...
var file_gRPC_applist_proto_depIdxs = []int32{
	...
	56, // 5: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	...
	56, // 9: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	...
	56, // 13: AppStatus.LastDeployed:type_name -> google.protobuf.Timestamp
	...
	54, // 20: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	...
	56, // 27: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	...
	40, // 41: TemplateChartResponseWithChart.templateChartResponse:type_name -> TemplateChartResponse
	44, // 42: TemplateChartResponseWithChart.chartBytes:type_name -> ChartContent
	44, // 43: HelmInstallCustomRequest.chartContent:type_name -> ChartContent
	30, // 44: HelmInstallCustomRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	45, // 45: ResourceFilter.gvk:type_name -> Gvk
	47, // 46: ResourceFilter.resourceIdentifier:type_name -> ResourceIdentifier
	55, // 47: ResourceIdentifier.labels:type_name -> ResourceIdentifier.LabelsEntry
	47, // 48: ResourceTreeFilter.globalFilter:type_name -> ResourceIdentifier
	46, // 49: ResourceTreeFilter.resourceFilters:type_name -> ResourceFilter
	51, // 50: OCIRegistryRequest.RegistryCredential:type_name -> RegistryCredential
	53, // 51: OCIRegistryResponse.PushResult:type_name -> OCIRegistryPushResponse
	...
	39, // 66: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	36, // 67: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	36, // 68: ApplicationService.TemplateChartAndRetrieveChart:input_type -> InstallReleaseRequest
	42, // 69: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	...
	51, // 72: ApplicationService.ValidateOCIRegistry:input_type -> RegistryCredential
	50, // 73: ApplicationService.PushHelmChartToOCIRegistry:input_type -> OCIRegistryRequest
	...
	37, // 86: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	32, // 87: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	38, // 88: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	38, // 89: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	40, // 90: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	41, // 91: ApplicationService.TemplateChartAndRetrieveChart:output_type -> TemplateChartResponseWithChart
	...
	52, // 95: ApplicationService.ValidateOCIRegistry:output_type -> OCIRegistryResponse
	52, // 96: ApplicationService.PushHelmChartToOCIRegistry:output_type -> OCIRegistryResponse
