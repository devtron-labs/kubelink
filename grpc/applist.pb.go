...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x22, 0x99, 0x03, 0x0a, 0x12, 0x52, 0x65,
	...
	0x12, 0x53, 0x0a, 0x18, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x6e, 0x6e,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x18, 0x52, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1e, 0x0a, 0x0a, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	0x79, 0x49, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x72, 0x79, 0x49, 0x64, 0x22, 0x29, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x43, 0x6f,
	...
	0x68, 0x4b, 0x65, 0x79, 0x22, 0xc9, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x43,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	0x43, 0x0a, 0x10, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74,
	0x68, 0x6f, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x52, 0x10, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65,
	...
	0x52, 0x4c, 0x2a, 0x2c, 0x0a, 0x16, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e,
	...
	0x32, 0xe3, 0x0b, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
...
var file_grpc_applist_proto_depIdxs = []int32{
	1,  // 0: AppListRequest.clusters:type_name -> ClusterConfig
	1,  // 1: ExternalResourceTreeRequest.clusterConfig:type_name -> ClusterConfig
	4,  // 2: ExternalResourceTreeRequest.externalResourceDetail:type_name -> ExternalResourceDetail
	6,  // 3: DeployedAppList.DeployedAppDetail:type_name -> DeployedAppDetail
	7,  // 4: DeployedAppDetail.environmentDetail:type_name -> EnvironmentDetails
	59, // 5: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	1,  // 6: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	48, // 7: AppDetailRequest.resourceTreeFilter:type_name -> ResourceTreeFilter
	11, // 8: AppDetail.releaseStatus:type_name -> ReleaseStatus
	59, // 9: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	12, // 10: AppDetail.chartMetadata:type_name -> ChartMetadata
	13, // 11: AppDetail.resourceTreeResponse:type_name -> ResourceTreeResponse
	7,  // 12: AppDetail.environmentDetails:type_name -> EnvironmentDetails
	59, // 13: AppStatus.LastDeployed:type_name -> google.protobuf.Timestamp
	14, // 14: ResourceTreeResponse.nodes:type_name -> ResourceNode
	19, // 15: ResourceTreeResponse.podMetadata:type_name -> PodMetadata
	18, // 16: ResourceNode.parentRefs:type_name -> ResourceRef
	17, // 17: ResourceNode.networkingInfo:type_name -> ResourceNetworkingInfo
	16, // 18: ResourceNode.health:type_name -> HealthStatus
	15, // 19: ResourceNode.info:type_name -> InfoItem
	57, // 20: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	20, // 21: PodMetadata.ephemeralContainers:type_name -> EphemeralContainerData
	1,  // 22: HibernateRequest.clusterConfig:type_name -> ClusterConfig
	22, // 23: HibernateRequest.objectIdentifier:type_name -> ObjectIdentifier
	22, // 24: HibernateStatus.targetObject:type_name -> ObjectIdentifier
	23, // 25: HibernateResponse.status:type_name -> HibernateStatus
	12, // 26: HelmAppDeploymentDetail.chartMetadata:type_name -> ChartMetadata
	59, // 27: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	25, // 28: HelmAppDeploymentHistory.deploymentHistory:type_name -> HelmAppDeploymentDetail
	6,  // 29: ReleaseInfo.deployedAppDetail:type_name -> DeployedAppDetail
	1,  // 30: ObjectRequest.clusterConfig:type_name -> ClusterConfig
	22, // 31: ObjectRequest.objectIdentifier:type_name -> ObjectIdentifier
	1,  // 32: ReleaseIdentifier.clusterConfig:type_name -> ClusterConfig
	31, // 33: UpgradeReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	44, // 34: UpgradeReleaseRequest.chartContent:type_name -> ChartContent
	31, // 35: DeploymentDetailRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	31, // 36: InstallReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	36, // 37: InstallReleaseRequest.chartRepository:type_name -> ChartRepository
	51, // 38: InstallReleaseRequest.RegistryCredential:type_name -> RegistryCredential
	44, // 39: InstallReleaseRequest.chartContent:type_name -> ChartContent
	31, // 40: RollbackReleaseRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	44, // 41: HelmInstallCustomRequest.chartContent:type_name -> ChartContent
	31, // 42: HelmInstallCustomRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	45, // 43: ResourceFilter.gvk:type_name -> Gvk
	47, // 44: ResourceFilter.resourceIdentifier:type_name -> ResourceIdentifier
	58, // 45: ResourceIdentifier.labels:type_name -> ResourceIdentifier.LabelsEntry
	47, // 46: ResourceTreeFilter.globalFilter:type_name -> ResourceIdentifier
	46, // 47: ResourceTreeFilter.resourceFilters:type_name -> ResourceFilter
	51, // 48: OCIRegistryRequest.RegistryCredential:type_name -> RegistryCredential
	54, // 49: RegistryCredential.RegistryConnectionConfig:type_name -> ServerConnectionConfig
	0,  // 50: ServerConnectionConfig.ConnectionMethod:type_name -> ServerConnectionMethod
	52, // 51: ServerConnectionConfig.ProxyConfig:type_name -> ProxyConfig
	53, // 52: ServerConnectionConfig.SSHTunnelConfig:type_name -> SSHTunnelConfig
	56, // 53: OCIRegistryResponse.PushResult:type_name -> OCIRegistryPushResponse
	2,  // 54: ApplicationService.ListApplications:input_type -> AppListRequest
	8,  // 55: ApplicationService.GetAppDetail:input_type -> AppDetailRequest
	8,  // 56: ApplicationService.GetAppStatus:input_type -> AppDetailRequest
	21, // 57: ApplicationService.Hibernate:input_type -> HibernateRequest
	21, // 58: ApplicationService.UnHibernate:input_type -> HibernateRequest
	8,  // 59: ApplicationService.GetDeploymentHistory:input_type -> AppDetailRequest
	8,  // 60: ApplicationService.GetValuesYaml:input_type -> AppDetailRequest
	28, // 61: ApplicationService.GetDesiredManifest:input_type -> ObjectRequest
	31, // 62: ApplicationService.UninstallRelease:input_type -> ReleaseIdentifier
	32, // 63: ApplicationService.UpgradeRelease:input_type -> UpgradeReleaseRequest
	34, // 64: ApplicationService.GetDeploymentDetail:input_type -> DeploymentDetailRequest
	37, // 65: ApplicationService.InstallRelease:input_type -> InstallReleaseRequest
	37, // 66: ApplicationService.UpgradeReleaseWithChartInfo:input_type -> InstallReleaseRequest
	31, // 67: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	40, // 68: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	37, // 69: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	42, // 70: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	37, // 71: ApplicationService.GetNotes:input_type -> InstallReleaseRequest
	32, // 72: ApplicationService.UpgradeReleaseWithCustomChart:input_type -> UpgradeReleaseRequest
	51, // 73: ApplicationService.ValidateOCIRegistry:input_type -> RegistryCredential
	50, // 74: ApplicationService.PushHelmChartToOCIRegistry:input_type -> OCIRegistryRequest
	3,  // 75: ApplicationService.GetResourceTreeForExternalResources:input_type -> ExternalResourceTreeRequest
	5,  // 76: ApplicationService.ListApplications:output_type -> DeployedAppList
	9,  // 77: ApplicationService.GetAppDetail:output_type -> AppDetail
	10, // 78: ApplicationService.GetAppStatus:output_type -> AppStatus
	24, // 79: ApplicationService.Hibernate:output_type -> HibernateResponse
	24, // 80: ApplicationService.UnHibernate:output_type -> HibernateResponse
	26, // 81: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	27, // 82: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	29, // 83: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	30, // 84: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	33, // 85: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	35, // 86: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	38, // 87: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	33, // 88: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	39, // 89: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	39, // 90: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	41, // 91: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	43, // 92: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
	49, // 93: ApplicationService.GetNotes:output_type -> ChartNotesResponse
	33, // 94: ApplicationService.UpgradeReleaseWithCustomChart:output_type -> UpgradeReleaseResponse
	55, // 95: ApplicationService.ValidateOCIRegistry:output_type -> OCIRegistryResponse
	55, // 96: ApplicationService.PushHelmChartToOCIRegistry:output_type -> OCIRegistryResponse
	13, // 97: ApplicationService.GetResourceTreeForExternalResources:output_type -> ResourceTreeResponse
