...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x03, 0x53, 0x53, 0x48, 0x10, 0x01, 0x32, 0x8e, 0x0d, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4d, 0x0a, 0x11, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61,
	0x74, 0x65, 0x43, 0x68, 0x61, 0x72, 0x74, 0x42, 0x75, 0x6c, 0x6b, 0x12, 0x1a, 0x2e, 0x42, 0x75,
	0x6c, 0x6b, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x42, 0x75, 0x6c, 0x6b, 0x54, 0x65,
	0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5a, 0x0a, 0x1d, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	0x65, 0x43, 0x68, 0x61, 0x72, 0x74, 0x41, 0x6e, 0x64, 0x52, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x57, 0x69, 0x74, 0x68, 0x43, 0x68, 0x61, 0x72, 0x74, 0x22,
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	0,  // 54: RemoteConnectionConfig.RemoteConnectionMethod:type_name -> RemoteConnectionMethod
	55, // 55: RemoteConnectionConfig.ProxyConfig:type_name -> ProxyConfig
	56, // 56: RemoteConnectionConfig.SSHTunnelConfig:type_name -> SSHTunnelConfig
	59, // 57: OCIRegistryResponse.PushResult:type_name -> OCIRegistryPushResponse
	2,  // 58: ApplicationService.ListApplications:input_type -> AppListRequest
	8,  // 59: ApplicationService.GetAppDetail:input_type -> AppDetailRequest
	8,  // 60: ApplicationService.GetAppStatus:input_type -> AppDetailRequest
	21, // 61: ApplicationService.Hibernate:input_type -> HibernateRequest
	21, // 62: ApplicationService.UnHibernate:input_type -> HibernateRequest
	8,  // 63: ApplicationService.GetDeploymentHistory:input_type -> AppDetailRequest
	8,  // 64: ApplicationService.GetValuesYaml:input_type -> AppDetailRequest
	28, // 65: ApplicationService.GetDesiredManifest:input_type -> ObjectRequest
	31, // 66: ApplicationService.UninstallRelease:input_type -> ReleaseIdentifier
	32, // 67: ApplicationService.UpgradeRelease:input_type -> UpgradeReleaseRequest
	34, // 68: ApplicationService.GetDeploymentDetail:input_type -> DeploymentDetailRequest
	37, // 69: ApplicationService.InstallRelease:input_type -> InstallReleaseRequest
	37, // 70: ApplicationService.UpgradeReleaseWithChartInfo:input_type -> InstallReleaseRequest
	31, // 71: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	41, // 72: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	37, // 73: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	38, // 74: ApplicationService.TemplateChartBulk:input_type -> BulkInstallReleaseRequest
	37, // 75: ApplicationService.TemplateChartAndRetrieveChart:input_type -> InstallReleaseRequest
	45, // 76: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	37, // 77: ApplicationService.GetNotes:input_type -> InstallReleaseRequest
	32, // 78: ApplicationService.UpgradeReleaseWithCustomChart:input_type -> UpgradeReleaseRequest
	54, // 79: ApplicationService.ValidateOCIRegistry:input_type -> RegistryCredential
	53, // 80: ApplicationService.PushHelmChartToOCIRegistry:input_type -> OCIRegistryRequest
	3,  // 81: ApplicationService.GetResourceTreeForExternalResources:input_type -> ExternalResourceTreeRequest
	5,  // 82: ApplicationService.ListApplications:output_type -> DeployedAppList
	9,  // 83: ApplicationService.GetAppDetail:output_type -> AppDetail
	10, // 84: ApplicationService.GetAppStatus:output_type -> AppStatus
	24, // 85: ApplicationService.Hibernate:output_type -> HibernateResponse
	24, // 86: ApplicationService.UnHibernate:output_type -> HibernateResponse
	26, // 87: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	27, // 88: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	29, // 89: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	30, // 90: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	33, // 91: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	35, // 92: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	39, // 93: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	33, // 94: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	40, // 95: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	40, // 96: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	42, // 97: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	43, // 98: ApplicationService.TemplateChartBulk:output_type -> BulkTemplateChartResponse
	44, // 99: ApplicationService.TemplateChartAndRetrieveChart:output_type -> TemplateChartResponseWithChart
	46, // 100: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
	52, // 101: ApplicationService.GetNotes:output_type -> ChartNotesResponse
	33, // 102: ApplicationService.UpgradeReleaseWithCustomChart:output_type -> UpgradeReleaseResponse
	58, // 103: ApplicationService.ValidateOCIRegistry:output_type -> OCIRegistryResponse
	58, // 104: ApplicationService.PushHelmChartToOCIRegistry:output_type -> OCIRegistryResponse
	13, // 105: ApplicationService.GetResourceTreeForExternalResources:output_type -> ResourceTreeResponse
