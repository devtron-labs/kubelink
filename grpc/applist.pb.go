...
type OCIRegistryResponse struct {
	...
	Result     *OCIRegistryPushResponse `protobuf:"bytes,2,opt,name=result,proto3" json:"result,omitempty"`
	ErrorMsg   string                   `protobuf:"bytes,3,opt,name=errorMsg,proto3" json:"errorMsg,omitempty"`
}
...
func (x *OCIRegistryResponse) GetResult() *OCIRegistryPushResponse {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *OCIRegistryResponse) GetErrorMsg() string {
	if x != nil {
		return x.ErrorMsg
	}
	return ""
...
func (x *OCIRegistryPushResponse) GetErrorMsg() string {
	if x != nil {
		return x.ErrorMsg
	}
	return ""
...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x83, 0x01, 0x0a, 0x13, 0x4f, 0x43, 0x49, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x69, 0x73, 0x4c,
	0x6f, 0x67, 0x67, 0x65, 0x64, 0x49, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x69,
	0x73, 0x4c, 0x6f, 0x67, 0x67, 0x65, 0x64, 0x49, 0x6e, 0x12, 0x30, 0x0a, 0x06, 0x72, 0x65, 0x73,
	...
	0x6e, 0x73, 0x65, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x4d, 0x73, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x4d, 0x73, 0x67, 0x22, 0x6b, 0x0a, 0x17, 0x4f, 0x43, 0x49, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x75,
	0x73, 0x68, 0x65, 0x64, 0x55, 0x52, 0x4c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70,
	0x75, 0x73, 0x68, 0x65, 0x64, 0x55, 0x52, 0x4c, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x72, 0x72, 0x6f,
	0x72, 0x4d, 0x73, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x65, 0x72, 0x72, 0x6f,
	0x72, 0x4d, 0x73, 0x67, 0x32, 0xe6, 0x09, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61,
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	48, // 41: OCIRegistryResponse.result:type_name -> OCIRegistryPushResponse
	...
	20, // 64: ApplicationService.Hibernate:output_type -> HibernateResponse
	20, // 65: ApplicationService.UnHibernate:output_type -> HibernateResponse
	22, // 66: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	23, // 67: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	25, // 68: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	26, // 69: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	29, // 70: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	31, // 71: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	34, // 72: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	29, // 73: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	35, // 74: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	35, // 75: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	37, // 76: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	39, // 77: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
	45, // 78: ApplicationService.GetNotes:output_type -> ChartNotesResponse
	47, // 79: ApplicationService.ValidateOCIRegistry:output_type -> OCIRegistryResponse
