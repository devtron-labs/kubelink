...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x32, 0xb6, 0x08, 0x0a, 0x12, 0x41,
	...
	0x0a, 0x2e, 0x41, 0x70, 0x70, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x00, 0x12, 0x34, 0x0a,
...
var file_grpc_applist_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_grpc_applist_proto_goTypes = []interface{}{
	...
	(*TemplateChartResponse)(nil),     // 35: TemplateChartResponse
	(*HelmInstallCustomRequest)(nil),  // 36: HelmInstallCustomRequest
	(*HelmInstallCustomResponse)(nil), // 37: HelmInstallCustomResponse
	(*ChartContent)(nil),              // 38: ChartContent
	nil,                               // 39: ResourceNetworkingInfo.LabelsEntry
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	40, // 3: DeployedAppDetail.LastDeployed:type_name -> google.protobuf.Timestamp
	0,  // 4: AppDetailRequest.clusterConfig:type_name -> ClusterConfig
	7,  // 5: AppDetail.releaseStatus:type_name -> ReleaseStatus
	40, // 6: AppDetail.lastDeployed:type_name -> google.protobuf.Timestamp
	...
	39, // 15: ResourceNetworkingInfo.labels:type_name -> ResourceNetworkingInfo.LabelsEntry
	...
	40, // 21: HelmAppDeploymentDetail.deployedAt:type_name -> google.protobuf.Timestamp
	...
	38, // 32: HelmInstallCustomRequest.chartContent:type_name -> ChartContent
	25, // 33: HelmInstallCustomRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	1,  // 34: ApplicationService.ListApplications:input_type -> AppListRequest
	5,  // 35: ApplicationService.GetAppDetail:input_type -> AppDetailRequest
	15, // 36: ApplicationService.Hibernate:input_type -> HibernateRequest
	15, // 37: ApplicationService.UnHibernate:input_type -> HibernateRequest
	5,  // 38: ApplicationService.GetDeploymentHistory:input_type -> AppDetailRequest
	5,  // 39: ApplicationService.GetValuesYaml:input_type -> AppDetailRequest
	22, // 40: ApplicationService.GetDesiredManifest:input_type -> ObjectRequest
	25, // 41: ApplicationService.UninstallRelease:input_type -> ReleaseIdentifier
	26, // 42: ApplicationService.UpgradeRelease:input_type -> UpgradeReleaseRequest
	28, // 43: ApplicationService.GetDeploymentDetail:input_type -> DeploymentDetailRequest
	31, // 44: ApplicationService.InstallRelease:input_type -> InstallReleaseRequest
	31, // 45: ApplicationService.UpgradeReleaseWithChartInfo:input_type -> InstallReleaseRequest
	25, // 46: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	34, // 47: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	31, // 48: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	36, // 49: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	2,  // 50: ApplicationService.ListApplications:output_type -> DeployedAppList
	6,  // 51: ApplicationService.GetAppDetail:output_type -> AppDetail
	18, // 52: ApplicationService.Hibernate:output_type -> HibernateResponse
	18, // 53: ApplicationService.UnHibernate:output_type -> HibernateResponse
	20, // 54: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	21, // 55: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	23, // 56: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	24, // 57: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	27, // 58: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	29, // 59: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	32, // 60: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	27, // 61: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	33, // 62: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	33, // 63: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	35, // 64: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	37, // 65: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
