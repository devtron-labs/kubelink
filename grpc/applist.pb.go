...
func (x *TemplateChartResponseWithChart) GetChartBytes() string {
	if x != nil {
		return x.ChartBytes
	}
	return ""
...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x22, 0x8e, 0x01, 0x0a, 0x1e, 0x54,
	...
	0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63,
	0x68, 0x61, 0x72, 0x74, 0x42, 0x79, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x63, 0x68, 0x61, 0x72, 0x74, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xcb, 0x01, 0x0a, 0x18,
	...
	0x61, 0x73, 0x65, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1a, 0x0a,
	0x08, 0x52, 0x75, 0x6e, 0x49, 0x6e, 0x43, 0x74, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x52, 0x75, 0x6e, 0x49, 0x6e, 0x43, 0x74, 0x78, 0x22, 0x35, 0x0a, 0x19, 0x48, 0x65, 0x6c,
	...
	0x55, 0x52, 0x4c, 0x32, 0xbf, 0x0c, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74,
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	55, // 46: ResourceIdentifier.labels:type_name -> ResourceIdentifier.LabelsEntry
	...
	53, // 50: OCIRegistryResponse.PushResult:type_name -> OCIRegistryPushResponse
	...
	36, // 67: ApplicationService.TemplateChartAndRetrieveChart:input_type -> InstallReleaseRequest
	42, // 68: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	36, // 69: ApplicationService.GetNotes:input_type -> InstallReleaseRequest
	31, // 70: ApplicationService.UpgradeReleaseWithCustomChart:input_type -> UpgradeReleaseRequest
	51, // 71: ApplicationService.ValidateOCIRegistry:input_type -> RegistryCredential
	50, // 72: ApplicationService.PushHelmChartToOCIRegistry:input_type -> OCIRegistryRequest
	2,  // 73: ApplicationService.GetResourceTreeForExternalResources:input_type -> ExternalResourceTreeRequest
	4,  // 74: ApplicationService.ListApplications:output_type -> DeployedAppList
	8,  // 75: ApplicationService.GetAppDetail:output_type -> AppDetail
	9,  // 76: ApplicationService.GetAppStatus:output_type -> AppStatus
	23, // 77: ApplicationService.Hibernate:output_type -> HibernateResponse
	23, // 78: ApplicationService.UnHibernate:output_type -> HibernateResponse
	25, // 79: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	26, // 80: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	28, // 81: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	29, // 82: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	32, // 83: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	34, // 84: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	37, // 85: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	32, // 86: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	38, // 87: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	38, // 88: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	40, // 89: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	41, // 90: ApplicationService.TemplateChartAndRetrieveChart:output_type -> TemplateChartResponseWithChart
	43, // 91: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
	49, // 92: ApplicationService.GetNotes:output_type -> ChartNotesResponse
	32, // 93: ApplicationService.UpgradeReleaseWithCustomChart:output_type -> UpgradeReleaseResponse
	52, // 94: ApplicationService.ValidateOCIRegistry:output_type -> OCIRegistryResponse
	52, // 95: ApplicationService.PushHelmChartToOCIRegistry:output_type -> OCIRegistryResponse
	12, // 96: ApplicationService.GetResourceTreeForExternalResources:output_type -> ResourceTreeResponse
