...
type InstallReleaseRequest struct {
	...
	ReturnChartBytes           bool                `protobuf:"varint,12,opt,name=returnChartBytes,proto3" json:"returnChartBytes,omitempty"`
}
...
func (x *InstallReleaseRequest) GetReturnChartBytes() bool {
	if x != nil {
		return x.ReturnChartBytes
	}
	return false
}
...
func (x *TemplateChartResponse) GetChartBytes() *ChartContent {
	if x != nil {
		return x.ChartBytes
	}
	return nil
...
var file_grpc_applist_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x63, 0x68, 0x61, 0x72, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x2a,
	0x0a, 0x10, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x43, 0x68, 0x61, 0x72, 0x74, 0x42, 0x79, 0x74,
	0x65, 0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e,
	0x43, 0x68, 0x61, 0x72, 0x74, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0x32, 0x0a, 0x16, 0x49, 0x6e,
	...
	0x74, 0x0a, 0x15, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x72, 0x74,
	...
	0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x0a, 0x63, 0x68, 0x61, 0x72, 0x74, 0x42,
	...
	0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xcb, 0x01, 0x0a, 0x18, 0x48, 0x65, 0x6c, 0x6d, 0x49, 0x6e,
	...
	0x43, 0x74, 0x78, 0x22, 0x35, 0x0a, 0x19, 0x48, 0x65, 0x6c, 0x6d, 0x49, 0x6e, 0x73, 0x74, 0x61,
	...
	0x28, 0x09, 0x52, 0x09, 0x50, 0x75, 0x73, 0x68, 0x65, 0x64, 0x55, 0x52, 0x4c, 0x32, 0xe3, 0x0b,
...
var file_grpc_applist_proto_depIdxs = []int32{
	...
	43, // 41: TemplateChartResponse.chartBytes:type_name -> ChartContent
	43, // 42: HelmInstallCustomRequest.chartContent:type_name -> ChartContent
	30, // 43: HelmInstallCustomRequest.releaseIdentifier:type_name -> ReleaseIdentifier
	44, // 44: ResourceFilter.gvk:type_name -> Gvk
	46, // 45: ResourceFilter.resourceIdentifier:type_name -> ResourceIdentifier
	54, // 46: ResourceIdentifier.labels:type_name -> ResourceIdentifier.LabelsEntry
	46, // 47: ResourceTreeFilter.globalFilter:type_name -> ResourceIdentifier
	45, // 48: ResourceTreeFilter.resourceFilters:type_name -> ResourceFilter
	50, // 49: OCIRegistryRequest.RegistryCredential:type_name -> RegistryCredential
	52, // 50: OCIRegistryResponse.PushResult:type_name -> OCIRegistryPushResponse
	1,  // 51: ApplicationService.ListApplications:input_type -> AppListRequest
	7,  // 52: ApplicationService.GetAppDetail:input_type -> AppDetailRequest
	7,  // 53: ApplicationService.GetAppStatus:input_type -> AppDetailRequest
	20, // 54: ApplicationService.Hibernate:input_type -> HibernateRequest
	20, // 55: ApplicationService.UnHibernate:input_type -> HibernateRequest
	7,  // 56: ApplicationService.GetDeploymentHistory:input_type -> AppDetailRequest
	7,  // 57: ApplicationService.GetValuesYaml:input_type -> AppDetailRequest
	27, // 58: ApplicationService.GetDesiredManifest:input_type -> ObjectRequest
	30, // 59: ApplicationService.UninstallRelease:input_type -> ReleaseIdentifier
	31, // 60: ApplicationService.UpgradeRelease:input_type -> UpgradeReleaseRequest
	33, // 61: ApplicationService.GetDeploymentDetail:input_type -> DeploymentDetailRequest
	36, // 62: ApplicationService.InstallRelease:input_type -> InstallReleaseRequest
	36, // 63: ApplicationService.UpgradeReleaseWithChartInfo:input_type -> InstallReleaseRequest
	30, // 64: ApplicationService.IsReleaseInstalled:input_type -> ReleaseIdentifier
	39, // 65: ApplicationService.RollbackRelease:input_type -> RollbackReleaseRequest
	36, // 66: ApplicationService.TemplateChart:input_type -> InstallReleaseRequest
	41, // 67: ApplicationService.InstallReleaseWithCustomChart:input_type -> HelmInstallCustomRequest
	36, // 68: ApplicationService.GetNotes:input_type -> InstallReleaseRequest
	31, // 69: ApplicationService.UpgradeReleaseWithCustomChart:input_type -> UpgradeReleaseRequest
	50, // 70: ApplicationService.ValidateOCIRegistry:input_type -> RegistryCredential
	49, // 71: ApplicationService.PushHelmChartToOCIRegistry:input_type -> OCIRegistryRequest
	2,  // 72: ApplicationService.GetResourceTreeForExternalResources:input_type -> ExternalResourceTreeRequest
	4,  // 73: ApplicationService.ListApplications:output_type -> DeployedAppList
	8,  // 74: ApplicationService.GetAppDetail:output_type -> AppDetail
	9,  // 75: ApplicationService.GetAppStatus:output_type -> AppStatus
	23, // 76: ApplicationService.Hibernate:output_type -> HibernateResponse
	23, // 77: ApplicationService.UnHibernate:output_type -> HibernateResponse
	25, // 78: ApplicationService.GetDeploymentHistory:output_type -> HelmAppDeploymentHistory
	26, // 79: ApplicationService.GetValuesYaml:output_type -> ReleaseInfo
	28, // 80: ApplicationService.GetDesiredManifest:output_type -> DesiredManifestResponse
	29, // 81: ApplicationService.UninstallRelease:output_type -> UninstallReleaseResponse
	32, // 82: ApplicationService.UpgradeRelease:output_type -> UpgradeReleaseResponse
	34, // 83: ApplicationService.GetDeploymentDetail:output_type -> DeploymentDetailResponse
	37, // 84: ApplicationService.InstallRelease:output_type -> InstallReleaseResponse
	32, // 85: ApplicationService.UpgradeReleaseWithChartInfo:output_type -> UpgradeReleaseResponse
	38, // 86: ApplicationService.IsReleaseInstalled:output_type -> BooleanResponse
	38, // 87: ApplicationService.RollbackRelease:output_type -> BooleanResponse
	40, // 88: ApplicationService.TemplateChart:output_type -> TemplateChartResponse
	42, // 89: ApplicationService.InstallReleaseWithCustomChart:output_type -> HelmInstallCustomResponse
	48, // 90: ApplicationService.GetNotes:output_type -> ChartNotesResponse
	32, // 91: ApplicationService.UpgradeReleaseWithCustomChart:output_type -> UpgradeReleaseResponse
	51, // 92: ApplicationService.ValidateOCIRegistry:output_type -> OCIRegistryResponse
	51, // 93: ApplicationService.PushHelmChartToOCIRegistry:output_type -> OCIRegistryResponse
	12, // 94: ApplicationService.GetResourceTreeForExternalResources:output_type -> ResourceTreeResponse
