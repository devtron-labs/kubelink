...
type ApplicationServiceClient interface {
	...
	TemplateChartWrapper(ctx context.Context, in *InstallReleaseRequestWrapper, opts ...grpc.CallOption) (*TemplateChartResponseWrapper, error)
...
func (c *applicationServiceClient) TemplateChartWrapper(ctx context.Context, in *InstallReleaseRequestWrapper, opts ...grpc.CallOption) (*TemplateChartResponseWrapper, error) {
	out := new(TemplateChartResponseWrapper)
	err := c.cc.Invoke(ctx, "/ApplicationService/TemplateChartWrapper", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServiceServer interface {
	...
	TemplateChartWrapper(context.Context, *InstallReleaseRequestWrapper) (*TemplateChartResponseWrapper, error)
...
func (UnimplementedApplicationServiceServer) TemplateChartWrapper(context.Context, *InstallReleaseRequestWrapper) (*TemplateChartResponseWrapper, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TemplateChartWrapper not implemented")
}
...
func _ApplicationService_TemplateChartWrapper_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InstallReleaseRequestWrapper)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServiceServer).TemplateChartWrapper(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ApplicationService/TemplateChartWrapper",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServiceServer).TemplateChartWrapper(ctx, req.(*InstallReleaseRequestWrapper))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApplicationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TemplateChartWrapper",
			Handler:    _ApplicationService_TemplateChartWrapper_Handler,
		},
		{
