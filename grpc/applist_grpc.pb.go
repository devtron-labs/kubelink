...
type ApplicationServiceClient interface {
	...
	GetAppStatusWithLastDeployed(ctx context.Context, in *AppDetailRequest, opts ...grpc.CallOption) (*AppStatusWithLastDeployed, error)
...
func (c *applicationServiceClient) GetAppStatusWithLastDeployed(ctx context.Context, in *AppDetailRequest, opts ...grpc.CallOption) (*AppStatusWithLastDeployed, error) {
	out := new(AppStatusWithLastDeployed)
	err := c.cc.Invoke(ctx, "/ApplicationService/GetAppStatusWithLastDeployed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServiceServer interface {
	...
	GetAppStatusWithLastDeployed(context.Context, *AppDetailRequest) (*AppStatusWithLastDeployed, error)
...
func (UnimplementedApplicationServiceServer) GetAppStatusWithLastDeployed(context.Context, *AppDetailRequest) (*AppStatusWithLastDeployed, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAppStatusWithLastDeployed not implemented")
}
...
func _ApplicationService_GetAppStatusWithLastDeployed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppDetailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServiceServer).GetAppStatusWithLastDeployed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ApplicationService/GetAppStatusWithLastDeployed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServiceServer).GetAppStatusWithLastDeployed(ctx, req.(*AppDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApplicationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAppStatusWithLastDeployed",
			Handler:    _ApplicationService_GetAppStatusWithLastDeployed_Handler,
		},
		{
